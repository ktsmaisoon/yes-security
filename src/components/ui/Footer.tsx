  ...
  return (
    ...
    >
      ...
      >
        <div
          className="
            w-full max-w-[342px] mx-auto lg:max-w-none
        ...
        >
          ...
          <div className="col-span-1 mt-[56px] lg:mt-0 lg:ml-12">
          ...
          <div className="col-span-1 mt-[56px] lg:mt-0 lg:-ml-4">
          ...
          <div className="col-span-2 md:col-span-1 md:ml-0 lg:-ml-16 mt-[56px] lg:mt-0">
            <h4 className="text-gray-300 font-['Wix_Madefor_Display',_sans-serif] font-medium text-base mb-[24px]">Stay Inspired!</h4>
            <p className="text-white font-['Wix_Madefor_Display',_sans-serif] text-sm leading-relaxed mb-4 lg:whitespace-nowrap">
