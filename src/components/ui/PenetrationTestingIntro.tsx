...
export default function PenetrationTestingIntro() {
  return (
    <section aria-labelledby="pt-intro" className="text-white">
      <div className="mx-auto w-full sm:w-[1440px] sm:h-[368px] px-[24px] py-[50px] sm:px-[120px] sm:py-[100px] grid grid-cols-1 sm:grid-cols-2 items-start justify-between gap-[42px]">
        {/* Heading */}
        ...
        {/* Paragraph */}
        <div className="w-full sm:w-[538px] text-white mt-[8px] order-2 sm:order-none sm:col-start-2 sm:row-start-1">
